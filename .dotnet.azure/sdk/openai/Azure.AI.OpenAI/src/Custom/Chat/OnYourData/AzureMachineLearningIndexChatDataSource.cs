...
// [CodeGenSuppress("AzureMachineLearningIndexChatDataSource", typeof(string), typeof(IDictionary<string, BinaryData>), typeof(InternalAzureMachineLearningIndexChatDataSourceParameters))]
