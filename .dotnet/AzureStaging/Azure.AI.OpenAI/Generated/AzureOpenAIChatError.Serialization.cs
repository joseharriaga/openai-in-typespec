...
{
    public partial class AzureOpenAIChatError : IJsonModel<AzureOpenAIChatError>
    {
        ...
        internal static AzureOpenAIChatError DeserializeAzureOpenAIChatError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string type = default;
            AzureOpenAIChatErrorInnerError innerError = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("inner_error"u8))
                {
                    ...
                    innerError = AzureOpenAIChatErrorInnerError.DeserializeAzureOpenAIChatErrorInnerError(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
