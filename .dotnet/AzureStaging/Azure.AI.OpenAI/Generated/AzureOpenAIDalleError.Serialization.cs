...
{
    public partial class AzureOpenAIDalleError : IJsonModel<AzureOpenAIDalleError>
    {
        ...
        internal static AzureOpenAIDalleError DeserializeAzureOpenAIDalleError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string type = default;
            AzureOpenAIDalleErrorInnerError innerError = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("inner_error"u8))
                {
                    ...
                    innerError = AzureOpenAIDalleErrorInnerError.DeserializeAzureOpenAIDalleErrorInnerError(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
