...
{
    public partial class AzureChatCompletionResponseMessageContextCitation : IUtf8JsonSerializable, IJsonModel<AzureChatCompletionResponseMessageContextCitation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatCompletionResponseMessageContextCitation>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AzureChatCompletionResponseMessageContextCitation FromResponse(Response response)
        {
