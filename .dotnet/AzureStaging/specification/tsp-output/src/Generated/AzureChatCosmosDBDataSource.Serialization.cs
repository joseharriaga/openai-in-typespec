...
{
    public partial class AzureChatCosmosDBDataSource : IUtf8JsonSerializable, IJsonModel<AzureChatCosmosDBDataSource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatCosmosDBDataSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static new AzureChatCosmosDBDataSource FromResponse(Response response)
        {
