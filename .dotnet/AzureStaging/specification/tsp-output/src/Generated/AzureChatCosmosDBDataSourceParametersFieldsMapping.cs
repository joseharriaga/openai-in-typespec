...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatCosmosDBDataSourceParametersFieldsMapping
    {
        ...
        internal AzureChatCosmosDBDataSourceParametersFieldsMapping(string titleField, string urlField, string filepathField, IReadOnlyList<string> contentFields, string contentFieldsSeparator, IReadOnlyList<string> vectorFields, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
