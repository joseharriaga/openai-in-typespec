...
{
    [PersistableModelProxy(typeof(UnknownAzureChatDataSourceVectorizationSource))]
    public partial class AzureChatDataSourceVectorizationSource : IUtf8JsonSerializable, IJsonModel<AzureChatDataSourceVectorizationSource>
    {
        ...
        internal static AzureChatDataSourceVectorizationSource DeserializeAzureChatDataSourceVectorizationSource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return UnknownAzureChatDataSourceVectorizationSource.DeserializeUnknownAzureChatDataSourceVectorizationSource(element, options);
        }
        ...
        internal static AzureChatDataSourceVectorizationSource FromResponse(Response response)
        {
