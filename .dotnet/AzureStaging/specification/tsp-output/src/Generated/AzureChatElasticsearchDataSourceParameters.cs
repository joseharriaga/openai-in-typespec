...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatElasticsearchDataSourceParameters
    {
        ...
        internal AzureChatElasticsearchDataSourceParameters(Uri endpoint, string indexName, AzureChatDataSourceVectorizationSource embeddingDependency)
        {
        ...
        internal AzureChatElasticsearchDataSourceParameters(BinaryData authentication, int? topNDocuments, bool? inScope, int? strictness, string roleInformation, Uri endpoint, string indexName, AzureChatElasticsearchDataSourceParametersFieldsMapping fieldsMapping, string queryType, AzureChatDataSourceVectorizationSource embeddingDependency, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
