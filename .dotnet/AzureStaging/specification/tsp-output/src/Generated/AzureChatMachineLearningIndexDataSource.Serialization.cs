...
{
    public partial class AzureChatMachineLearningIndexDataSource : IUtf8JsonSerializable, IJsonModel<AzureChatMachineLearningIndexDataSource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatMachineLearningIndexDataSource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static new AzureChatMachineLearningIndexDataSource FromResponse(Response response)
        {
