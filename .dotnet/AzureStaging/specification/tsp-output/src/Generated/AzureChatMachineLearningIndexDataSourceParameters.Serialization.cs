...
{
    public partial class AzureChatMachineLearningIndexDataSourceParameters : IUtf8JsonSerializable, IJsonModel<AzureChatMachineLearningIndexDataSourceParameters>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatMachineLearningIndexDataSourceParameters>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AzureChatMachineLearningIndexDataSourceParameters FromResponse(Response response)
        {
