...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatPineconeDataSourceFieldsMapping
    {
        ...
        internal AzureChatPineconeDataSourceFieldsMapping(string titleField, string urlField, string filepathField, IReadOnlyList<string> contentFields, string contentFieldsSeparator, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
