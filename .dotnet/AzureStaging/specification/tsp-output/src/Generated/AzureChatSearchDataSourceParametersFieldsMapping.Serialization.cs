...
{
    public partial class AzureChatSearchDataSourceParametersFieldsMapping : IUtf8JsonSerializable, IJsonModel<AzureChatSearchDataSourceParametersFieldsMapping>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatSearchDataSourceParametersFieldsMapping>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static AzureChatSearchDataSourceParametersFieldsMapping FromResponse(Response response)
        {
