...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureContentFilterDetectionResult
    {
        ...
        internal AzureContentFilterDetectionResult(bool detected, bool filtered)
        {
            Detected = detected;
            Filtered = filtered;
        }
        ...
        internal AzureContentFilterDetectionResult(bool detected, bool filtered, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Detected = detected;
            Filtered = filtered;
