...
{
    public partial class AzureCreateChatCompletionRequest : IJsonModel<AzureCreateChatCompletionRequest>
    {
        ...
        internal static new AzureCreateChatCompletionRequest FromResponse(PipelineResponse response)
        {
