...
{
    public partial class AzureCreateChatCompletionResponse : IJsonModel<AzureCreateChatCompletionResponse>
    {
        ...
        internal static new AzureCreateChatCompletionResponse FromResponse(PipelineResponse response)
        {
