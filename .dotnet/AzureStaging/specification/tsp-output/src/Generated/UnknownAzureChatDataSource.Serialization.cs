...
{
    internal partial class UnknownAzureChatDataSource : IJsonModel<AzureChatDataSource>
    {
        ...
        internal static new UnknownAzureChatDataSource FromResponse(PipelineResponse response)
        {
