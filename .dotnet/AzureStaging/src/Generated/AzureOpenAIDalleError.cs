...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AzureOpenAIDalleError
    {
        ...
        internal AzureOpenAIDalleError(int? code, string message, string param, string type, InternalAzureOpenAIDalleErrorInnerError innerError, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Param = param;
