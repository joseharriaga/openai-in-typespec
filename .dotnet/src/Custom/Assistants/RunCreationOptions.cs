...
public partial class RunCreationOptions
{
    ...
    public IList<ThreadInitializationMessage> AdditionalMessages { get; init; } = new ChangeTrackingList<ThreadInitializationMessage>();
    ...
    /// </summary>
    [CodeGenMember("Tools")]
    public IList<ToolDefinition> ToolsOverride { get; init; } = new ChangeTrackingList<ToolDefinition>();
    ...
    public IDictionary<string, string> Metadata { get; init; } = new ChangeTrackingDictionary<string, string>();
