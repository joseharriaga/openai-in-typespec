...
public partial class ChatClient
{
    ...
    // Note: Remove convenience methods for now.
   // /// <summary>
   ...
   //         options);
    ...
    ///// <param name="options"> Additional options for the chat completion request. </param>
    ///// <returns> A streaming result with incremental chat completion updates. </returns>
    //public virtual Task<AsyncClientResultCollection<StreamingChatUpdate>> CompleteChatStreamingAsync(
    //    string message,
    //    int? choiceCount = null,
    //    ChatCompletionOptions options = null)
    ...
    ///// <param name="cancellationToken"> The cancellation token for the operation. </param>
    ///// <returns> A streaming result with incremental chat completion updates. </returns>
    //public virtual async Task<AsyncClientResultCollection<StreamingChatUpdate>> CompleteChatStreamingAsync(
    //    IEnumerable<ChatRequestMessage> messages,
    //    int? choiceCount = null,
    //    ChatCompletionOptions options = null)
    //{
    //    PipelineMessage requestMessage = CreateStreamingRequestMessage(messages, choiceCount, options);
    //    requestMessage.BufferResponse = false;
    ...
    //    ClientResult genericResult = ClientResult.FromResponse(response);
    //    return AsyncClientResultCollection<StreamingChatUpdate>.CreateFromResponse(
    //        genericResult,
    //        (responseForEnumeration) => SseAsyncEnumerator<StreamingChatUpdate>.EnumerateFromSseStream(
    //            responseForEnumeration.GetRawResponse().ContentStream,
    //            e => StreamingChatUpdate.DeserializeStreamingChatUpdates(e)));   
    ...
    private PipelineMessage CreateStreamingRequestMessage(IEnumerable<ChatRequestMessage> messages, int? choiceCount, ChatCompletionOptions options)
    {
