...
///     </list>
/// </summary>
[CodeGenModel("ChatCompletionRequestMessageContentPart")]
...
public abstract partial class ChatMessageContentPart
{
    ...
    public static ChatMessageContentPart CreateTextPart(string text)
    {
        ...
        return new InternalChatCompletionRequestMessageContentPartText(text);
    }
    ...
    public static ChatMessageContentPart CreateImagePart(Uri imageUri, ChatImageDetailLevel? imageDetailLevel = null)
    {
        ...
        InternalChatCompletionRequestMessageContentPartImageImageUrl innerData = new(imageUri)
        {
            Detail = imageDetailLevel
        };
        return new InternalChatCompletionRequestMessageContentPartImage(innerData);
    }
    ...
    public static ChatMessageContentPart CreateImagePart(BinaryData imageBytes, string imageBytesMediaType, ChatImageDetailLevel? imageDetailLevel = null)
    {
        ...
        InternalChatCompletionRequestMessageContentPartImageImageUrl innerData = new(imageBytes, imageBytesMediaType)
        {
            Detail = imageDetailLevel
        };
        return new InternalChatCompletionRequestMessageContentPartImage(innerData);
    ...
    public static ChatMessageContentPart CreateRefusalPart(string refusal)
    {
        ...
        return new InternalChatCompletionRequestMessageContentPartRefusal(refusal);
    }
