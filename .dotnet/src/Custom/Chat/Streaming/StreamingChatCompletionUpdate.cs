...
public partial class StreamingChatCompletionUpdate
{
    ...
    private IList<StreamingChatToolCallUpdate> _toolCallUpdates;
    private IList<ChatTokenLogProbabilityDetails> _contentTokenLogProbabilities;
    private IList<ChatTokenLogProbabilityDetails> _refusalTokenLogProbabilities;
    ...
    public IList<ChatTokenLogProbabilityDetails> ContentTokenLogProbabilities =>
    ...
    public IList<ChatTokenLogProbabilityDetails> RefusalTokenLogProbabilities =>
    ...
    public IList<StreamingChatToolCallUpdate> ToolCallUpdates
        => _toolCallUpdates
