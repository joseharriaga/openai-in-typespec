...
[CodeGenSuppress("CreateUploadAsync", typeof(InternalUploadJobCreationOptions))]
[CodeGenSuppress("CreateUploadAsync", typeof(BinaryContent), typeof(RequestOptions))]
[CodeGenSuppress("CreateUpload", typeof(InternalUploadJobCreationOptions))]
[CodeGenSuppress("CreateUpload", typeof(BinaryContent), typeof(RequestOptions))]
[CodeGenSuppress("AddUploadPartAsync", typeof(string), typeof(InternalUploadJobDataPartOptions))]
[CodeGenSuppress("AddUploadPartAsync", typeof(string), typeof(BinaryContent), typeof(string), typeof(RequestOptions))]
[CodeGenSuppress("AddUploadPart", typeof(string), typeof(InternalUploadJobDataPartOptions))]
[CodeGenSuppress("AddUploadPart", typeof(string), typeof(BinaryContent), typeof(string), typeof(RequestOptions))]
[CodeGenSuppress("CompleteUploadAsync", typeof(string), typeof(InternalUploadJobCompletionOptions))]
[CodeGenSuppress("CompleteUploadAsync", typeof(string), typeof(BinaryContent), typeof(RequestOptions))]
[CodeGenSuppress("CompleteUpload", typeof(string), typeof(InternalUploadJobCompletionOptions))]
