...
[CodeGenSuppress(nameof(OpenAIFileCollection), typeof(IReadOnlyList<OpenAIFile>), typeof(string))]
public partial class OpenAIFileCollection : ReadOnlyCollection<OpenAIFile>
{
    ...
    internal OpenAIFileCollection(IReadOnlyList<OpenAIFile> data, string @object, IDictionary<string, BinaryData> serializedAdditionalRawData)
        : base([.. data])
    {
        Object = @object;
