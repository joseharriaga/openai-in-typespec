...
public partial class GeneratedImage : IJsonModel<GeneratedImage>
{
    ...
    void IJsonModel<GeneratedImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        => ModelSerializationHelpers.SerializeInstance(this, SerializeGeneratedImage, writer, options);
    ...
    internal static void SerializeGeneratedImage(GeneratedImage instance, Utf8JsonWriter writer, ModelReaderWriterOptions options)
    {
        writer.WriteStartObject();
        if (Optional.IsDefined(instance.ImageBytes))
        {
            string base64Image = Convert.ToBase64String(instance.ImageBytes.ToArray());
            writer.WriteString("b64_json"u8, base64Image);
        }
        if (Optional.IsDefined(instance.ImageUri))
        {
            writer.WriteString("url"u8, instance.ImageUri!.AbsoluteUri);
        }
        if (Optional.IsDefined(instance.RevisedPrompt))
        {
            writer.WriteString("revised_prompt"u8, instance.RevisedPrompt);
        }
