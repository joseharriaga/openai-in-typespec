...
/// <see cref="ConversationItemStartedUpdate"/> (<c>response.output_item.added</c>) and
/// <see cref="ConversationItemAcknowledgedUpdate"/> (<c>conversation.item.created</c>) commands that initialize
...
/// <see cref="ConversationFunctionCallArgumentsFinishedUpdate"/> commands or
/// <see cref="ConversationItemFinishedUpdate.FunctionCallArguments"/>. Using this incremental JSON deltas requires the
/// use of a compatible, incremental parser.
/// </remarks>
[Experimental("OPENAI002")]
[CodeGenModel("RealtimeServerEventResponseFunctionCallArgumentsDelta")]
public partial class ConversationFunctionCallArgumentsDeltaUpdate
{ }
