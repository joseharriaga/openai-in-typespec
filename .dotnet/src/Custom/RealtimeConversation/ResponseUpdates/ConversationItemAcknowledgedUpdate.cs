...
/// <see cref="ConversationItemStartedUpdate"/> (<c>response.output_item.added</c>) command, in which case the newly-
...
/// <see cref="ConversationItemFinishedUpdate"/> (<c>response.output_item.done</c>).
/// </summary>
