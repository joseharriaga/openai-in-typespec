...
/// <see cref="ConversationItemAcknowledgedUpdate"/> (<c>conversation.item.created</c>), and
/// <see cref="ConversationContentPartStartedUpdate"/> (<c>response.content_part.added)</c> commands that initialize
...
public partial class ConversationTextContentDeltaUpdate
{ }
