...
namespace OpenAI.Internal
{
    ...
    internal partial class Messages
    {
        ...
        /// </param>
        /// <param name="runId"> When provided, limits listed messages to those generated by the specified run. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="threadId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<ClientResult<ListMessagesResponse>> GetMessagesAsync(string threadId, int? limit = null, ListOrder? order = null, string after = null, string before = null, string runId = null)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));

            ClientResult result = await GetMessagesAsync(threadId, limit, order?.ToString(), after, before, runId, DefaultRequestContext).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="threadId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="threadId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ClientResult<ListMessagesResponse> GetMessages(string threadId, int? limit = null, ListOrder? order = null, string after = null, string before = null, string runId = null)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));

            ClientResult result = GetMessages(threadId, limit, order?.ToString(), after, before, runId, DefaultRequestContext);
            return ClientResult.FromValue(ListMessagesResponse.FromResponse(result.GetRawResponse()), result.GetRawResponse());
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMessagesAsync(string,int?,ListOrder?,string,string,string)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<ClientResult> GetMessagesAsync(string threadId, int? limit, string order, string after, string before, string runId, RequestOptions options)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));

            using PipelineMessage message = CreateGetMessagesRequest(threadId, limit, order, after, before, runId, options);
            return ClientResult.FromResponse(await _pipeline.ProcessMessageAsync(message, options).ConfigureAwait(false));
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetMessages(string,int?,ListOrder?,string,string,string)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ClientResultException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual ClientResult GetMessages(string threadId, int? limit, string order, string after, string before, string runId, RequestOptions options)
        {
            Argument.AssertNotNullOrEmpty(threadId, nameof(threadId));
        ...
        internal PipelineMessage CreateGetMessagesRequest(string threadId, int? limit, string order, string after, string before, string runId, RequestOptions options)
        {
            var message = _pipeline.CreateMessage();
            message.ResponseClassifier = PipelineMessageClassifier200;
            var request = message.Request;
