...
namespace OpenAI.Assistants
{
    ...
    public partial class AssistantModificationOptions
    {
        ...
        internal AssistantModificationOptions(string model, string name, string description, string instructions, IList<BinaryData> tools, ModifyAssistantRequestToolResources toolResources, IDictionary<string, string> metadata, float? temperature, float? topP, BinaryData responseFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            Name = name;
