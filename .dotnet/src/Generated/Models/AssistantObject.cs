...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class AssistantObject
    {
        ...
        internal AssistantObject(string id, DateTimeOffset createdAt, string name, string description, string model, string instructions, IEnumerable<AssistantToolDefinition> tools, IReadOnlyDictionary<string, string> metadata)
        {
        ...
        internal AssistantObject(string id, AssistantObjectObject @object, DateTimeOffset createdAt, string name, string description, string model, string instructions, IReadOnlyList<AssistantToolDefinition> tools, AssistantObjectToolResources toolResources, IReadOnlyDictionary<string, string> metadata, float? temperature, float? topP, BinaryData responseFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            CreatedAt = createdAt;
