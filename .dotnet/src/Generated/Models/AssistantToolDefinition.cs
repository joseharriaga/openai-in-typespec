...
namespace OpenAI.Internal.Models
{
    ...
    /// </summary>
    internal abstract partial class AssistantToolDefinition
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssistantToolDefinition"/>. </summary>
        protected AssistantToolDefinition()
        {
        }
        ...
        internal AssistantToolDefinition(string type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
