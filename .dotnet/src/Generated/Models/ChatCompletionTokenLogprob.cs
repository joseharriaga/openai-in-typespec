...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class ChatCompletionTokenLogprob
    {
        ...
        internal ChatCompletionTokenLogprob(string token, double logprob, IEnumerable<int> bytes, IEnumerable<ChatCompletionTokenLogprobTopLogprob> topLogprobs)
        {
        ...
        internal ChatCompletionTokenLogprob(string token, double logprob, IReadOnlyList<int> bytes, IReadOnlyList<ChatCompletionTokenLogprobTopLogprob> topLogprobs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Token = token;
            Logprob = logprob;
            Bytes = bytes;
