...
{
    public partial class ConversationAudioContentFinishedUpdate : IJsonModel<ConversationAudioContentFinishedUpdate>
    {
        void IJsonModel<ConversationAudioContentFinishedUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationAudioContentFinishedUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConversationAudioContentFinishedUpdate)} does not support writing '{format}' format.");
            }
        ...
        ConversationAudioContentFinishedUpdate IJsonModel<ConversationAudioContentFinishedUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConversationAudioContentFinishedUpdate)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeConversationAudioContentFinishedUpdate(document.RootElement, options);
        }

        internal static ConversationAudioContentFinishedUpdate DeserializeConversationAudioContentFinishedUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConversationAudioContentFinishedUpdate(
                type,
                eventId,
        ...
        BinaryData IPersistableModel<ConversationAudioContentFinishedUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConversationAudioContentFinishedUpdate)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ConversationAudioContentFinishedUpdate IPersistableModel<ConversationAudioContentFinishedUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ConversationAudioContentFinishedUpdate)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ConversationAudioContentFinishedUpdate>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        internal static new ConversationAudioContentFinishedUpdate FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeConversationAudioContentFinishedUpdate(document.RootElement);
        }
