...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateAssistantRequest
    {
        ...
        internal CreateAssistantRequest(CreateAssistantRequestModel model, string name, string description, string instructions, IList<AssistantToolDefinition> tools, CreateAssistantRequestToolResources toolResources, IDictionary<string, string> metadata, float? temperature, float? topP, BinaryData responseFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            Name = name;
