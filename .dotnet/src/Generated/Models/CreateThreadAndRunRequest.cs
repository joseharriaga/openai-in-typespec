...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateThreadAndRunRequest
    {
        ...
        internal CreateThreadAndRunRequest(string assistantId, CreateThreadRequest thread, CreateThreadAndRunRequestModel? model, string instructions, IList<AssistantToolDefinition> tools, CreateThreadAndRunRequestToolResources toolResources, IDictionary<string, string> metadata, float? temperature, float? topP, bool? stream, int? maxPromptTokens, int? maxCompletionTokens, TruncationObject truncationStrategy, BinaryData toolChoice, BinaryData responseFormat, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssistantId = assistantId;
            Thread = thread;
            Model = model;
