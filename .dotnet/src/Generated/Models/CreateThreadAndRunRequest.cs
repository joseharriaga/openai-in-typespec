...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateThreadAndRunRequest
    {
        ...
        internal CreateThreadAndRunRequest(string assistantId, CreateThreadRequest thread, string model, string instructions, IList<BinaryData> tools, IDictionary<string, string> metadata, double? temperature, bool? stream, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssistantId = assistantId;
            Thread = thread;
            Model = model;
