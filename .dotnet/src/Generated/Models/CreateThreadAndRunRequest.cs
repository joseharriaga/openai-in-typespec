...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateThreadAndRunRequest
    {
        ...
        internal CreateThreadAndRunRequest(string assistantId, CreateThreadRequest thread, string model, string instructions, IList<BinaryData> tools, bool? stream, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssistantId = assistantId;
            Thread = thread;
            Model = model;
