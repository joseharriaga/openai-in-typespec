...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class CreateThreadRequest
    {
        ...
        internal CreateThreadRequest(IList<MessageCreationOptions> messages, CreateThreadRequestToolResources toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
