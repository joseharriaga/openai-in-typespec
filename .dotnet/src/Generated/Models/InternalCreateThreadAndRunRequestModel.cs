...
namespace OpenAI.Assistants
{
    ...
    internal readonly partial struct InternalCreateThreadAndRunRequestModel : IEquatable<InternalCreateThreadAndRunRequestModel>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalCreateThreadAndRunRequestModel"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalCreateThreadAndRunRequestModel"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalCreateThreadAndRunRequestModel"/> values are not the same. </summary>
        public static bool operator !=(InternalCreateThreadAndRunRequestModel left, InternalCreateThreadAndRunRequestModel right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="InternalCreateThreadAndRunRequestModel"/>. </summary>
