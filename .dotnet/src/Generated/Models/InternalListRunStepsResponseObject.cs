...
namespace OpenAI.Assistants
{
    ...
    internal readonly partial struct InternalListRunStepsResponseObject : IEquatable<InternalListRunStepsResponseObject>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InternalListRunStepsResponseObject"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalListRunStepsResponseObject"/> values are the same. </summary>
        ...
        /// <summary> Determines if two <see cref="InternalListRunStepsResponseObject"/> values are not the same. </summary>
        public static bool operator !=(InternalListRunStepsResponseObject left, InternalListRunStepsResponseObject right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="InternalListRunStepsResponseObject"/>. </summary>
