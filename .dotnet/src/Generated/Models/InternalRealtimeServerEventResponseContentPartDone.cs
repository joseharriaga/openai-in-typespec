...
namespace OpenAI.RealtimeConversation
{
    ...
    {
        internal InternalRealtimeServerEventResponseContentPartDone(string responseId, string itemId, int outputIndex, int contentIndex, ConversationContentPart internalContentPart, string eventId) : base(eventId, RealtimeConversation.ConversationUpdateKind.ItemContentPartFinished)
        {
