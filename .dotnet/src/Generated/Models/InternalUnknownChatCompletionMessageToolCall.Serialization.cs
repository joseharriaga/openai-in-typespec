...
{
    internal partial class InternalUnknownChatCompletionMessageToolCall : IJsonModel<ChatToolCall>
    {
        ...
        internal static InternalUnknownChatCompletionMessageToolCall DeserializeInternalUnknownChatCompletionMessageToolCall(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new InternalUnknownChatCompletionMessageToolCall(type, serializedAdditionalRawData);
        }
        ...
        internal static new InternalUnknownChatCompletionMessageToolCall FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeInternalUnknownChatCompletionMessageToolCall(document.RootElement);
        }

        internal override BinaryContent ToBinaryContent()
        {
            return BinaryContent.Create<ChatToolCall>(this, ModelSerializationExtensions.WireOptions);
        }
    }
}
