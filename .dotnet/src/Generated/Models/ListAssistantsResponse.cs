...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class ListAssistantsResponse
    {
        ...
        internal ListAssistantsResponse(string @object, IEnumerable<AssistantObject> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal ListAssistantsResponse(string @object, IReadOnlyList<AssistantObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
