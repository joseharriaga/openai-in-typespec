...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class MessageObjectIncompleteDetails
    {
        ...
        internal MessageObjectIncompleteDetails(string reason)
        {
        ...
        internal MessageObjectIncompleteDetails(string reason, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Reason = reason;
