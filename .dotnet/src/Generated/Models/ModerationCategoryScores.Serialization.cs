...
namespace OpenAI.Moderations
{
    public partial class ModerationCategoryScores : IJsonModel<ModerationCategoryScores>
    {
        ...
        public static implicit operator BinaryContent(ModerationCategoryScores moderationCategoryScores)
        {
            return BinaryContent.Create(moderationCategoryScores, ModelSerializationExtensions.WireOptions);
        }

        public static explicit operator ModerationCategoryScores(ClientResult result)
        {
            using PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content);
            return DeserializeModerationCategoryScores(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
