...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class RunStepDeltaObjectDelta
    {
        ...
        {
            StepDetails = new ChangeTrackingList<BinaryData>();
        }

        /// <summary> Initializes a new instance of <see cref="RunStepDeltaObjectDelta"/>. </summary>
        /// <param name="stepDetails"> The details of the run step. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal RunStepDeltaObjectDelta(IReadOnlyList<BinaryData> stepDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// </para>
        /// </summary>
        public IReadOnlyList<BinaryData> StepDetails { get; }
    }
}
