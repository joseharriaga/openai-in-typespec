...
namespace OpenAI.Assistants
{
    ...
    public partial class ThreadCreationOptions
    {
        ...
        internal ThreadCreationOptions(IList<MessageCreationOptions> internalMessages, ToolResourceDefinitionCollection toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
