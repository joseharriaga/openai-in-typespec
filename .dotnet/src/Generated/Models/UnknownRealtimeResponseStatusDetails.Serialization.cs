...
namespace OpenAI.RealtimeConversation
{
    internal partial class UnknownRealtimeResponseStatusDetails : IJsonModel<ConversationStatusDetails>
    {
        ...
        InternalRealtimeResponseStatusDetails IJsonModel<InternalRealtimeResponseStatusDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UnknownRealtimeResponseStatusDetails)JsonModelCreateCore(ref reader, options);
        ...
        internal static UnknownRealtimeResponseStatusDetails DeserializeUnknownRealtimeResponseStatusDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownRealtimeResponseStatusDetails(@type, additionalBinaryDataProperties);
        }
        ...
        InternalRealtimeResponseStatusDetails IPersistableModel<InternalRealtimeResponseStatusDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => (UnknownRealtimeResponseStatusDetails)PersistableModelCreateCore(data, options);
