...
namespace OpenAI.Internal.Models
{
    ...
    internal partial class VectorStoreFileObject
    {
        ...
        internal VectorStoreFileObject(string id, int usageBytes, DateTimeOffset createdAt, string vectorStoreId, string status, VectorStoreFileObjectLastError lastError)
        {
        ...
        internal VectorStoreFileObject(string id, string @object, int usageBytes, DateTimeOffset createdAt, string vectorStoreId, string status, VectorStoreFileObjectLastError lastError, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Object = @object;
            UsageBytes = usageBytes;
