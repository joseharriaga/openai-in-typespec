...
namespace OpenAI
{
    public partial class OpenAIClient
    {
        ...
        {
            return Volatile.Read(ref _cachedOpenAIFileClient) ?? Interlocked.CompareExchange(ref _cachedOpenAIFileClient, new OpenAIFileClient(Pipeline, _keyCredential, _endpoint), null) ?? _cachedOpenAIFileClient;
        }
        ...
        {
            return Volatile.Read(ref _cachedOpenAIModelClient) ?? Interlocked.CompareExchange(ref _cachedOpenAIModelClient, new OpenAIModelClient(Pipeline, _keyCredential, _endpoint), null) ?? _cachedOpenAIModelClient;
        }
        ...
        {
            return Volatile.Read(ref _cachedRealtimeConversationClient) ?? Interlocked.CompareExchange(ref _cachedRealtimeConversationClient, new RealtimeConversationClient(Pipeline, _keyCredential, _endpoint), null) ?? _cachedRealtimeConversationClient;
        }
