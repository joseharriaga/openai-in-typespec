...
namespace OpenAI
{
    ...
    internal static partial class OpenAIModelFactory
    {
        ...
        public static MessageCreationOptions MessageCreationOptions(MessageRole role = default, IEnumerable<MessageContent> content = null, IEnumerable<MessageCreationAttachment> attachments = null, IDictionary<string, string> metadata = null)
        {
