...
public partial class AssistantTests
{
    ...
    [Test]
    public void CanEnumerateAssistants()
    {
        AssistantClient client = GetTestClient();
    ...
    //    IEnumerable<Assistant> enumerable = client.GetAssistants(ListOrder.NewestFirst, pageSize: 100);
    //    int totalCount = enumerable.Count();

    //    // Page through collection
    //    int itemCount = 0;
    //    int pageCount = 0;
    //    IAs<Assistant> assistants = client.GetAssistantsAsync(pageSize: 2, itemOrder: ListOrder.NewestFirst);
