...
function Edit-GeneratedModels {
    ...
    $exclusions = @(
        ...
        "OpenAIFileStatus.cs",
        "UploadJob.cs",
        "UploadJob.Serialization.cs",
        "UploadJobCompletionOptions.cs",
        "UploadJobCompletionOptions.Serialization.cs",
        "UploadJobCreationPurpose.cs",
        "UploadJobCreationPurpose.Serialization.cs",
        "UploadJobDataPart.cs",
        "UploadJobDataPart.Serialization.cs",
        "UploadJobStatus.cs",
        "UploadJobStatus.Serialization.cs",
