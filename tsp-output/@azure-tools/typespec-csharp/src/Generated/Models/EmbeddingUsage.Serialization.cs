...
{
    public partial class EmbeddingUsage : IUtf8JsonWriteable, IJsonModel<EmbeddingUsage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmbeddingUsage>)this).Write(writer, new ModelReaderWriterOptions("W"));
