...
{
    public partial class SubmitToolOutputsRunRequestToolOutput : IUtf8JsonWriteable, IJsonModel<SubmitToolOutputsRunRequestToolOutput>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubmitToolOutputsRunRequestToolOutput>)this).Write(writer, new ModelReaderWriterOptions("W"));
