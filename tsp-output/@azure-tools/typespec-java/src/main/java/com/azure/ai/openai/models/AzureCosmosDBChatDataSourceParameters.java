...
public final class AzureCosmosDBChatDataSourceParameters
     ...
     */
    @Generated
    public AzureCosmosDBChatDataSourceParameters setRoleInformation(String roleInformation) {
    ...
    public static AzureCosmosDBChatDataSourceParameters fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            deserializedAzureCosmosDBChatDataSourceParameters.roleInformation = roleInformation;
